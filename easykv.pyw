...
# Pyinstaller includes path configuration
# via https://www.reddit.com/r/learnpython/comments/4kjie3/how_to_include_gui_images_with_pyinstaller/
...
helpBtn = Button(btnFrame2, text="Visit carayo.com", command=website)
...
saveBtn = Button(btnFrame, text="Export", command=core)
